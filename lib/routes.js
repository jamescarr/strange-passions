...
exports.connect = function(app){
  ...
  app.get('/overall-rating/:talk', function(req, res){
    talks.getVotesForTalk(req.params.talk, function(err, doc){
    res.send(sys.inspect(req.params.talk + " : " + err))
 //     sendJson(res, doc == null?err:doc);
    });
  });
